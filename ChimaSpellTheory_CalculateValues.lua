...
function ChimaSpellTheory_CalculateDmgHealValue(spellID)
  if _G["spellData" .. playerClass][spellID] ~= nil then
    ...
    if _G["spellData" .. playerClass][spellID].isHeal then
      ...
      valueHeal = _G["ChimaSpellTheory_AddTalentValue" .. playerClass](spellID, baseHeal + bonusHeal, heal)
    end
    ...
    if _G["spellData" .. playerClass][spellID].isHot or _G["spellData" .. playerClass][spellID].isChanHeal then
      ...
      valueHot = _G["ChimaSpellTheory_AddTalentValue" .. playerClass](spellID, baseHeal + bonusHeal, hot)
    end
    ...
    if _G["spellData" .. playerClass][spellID].isCastDmg then
      ...
      valueDmg = _G["ChimaSpellTheory_AddTalentValue" .. playerClass](spellID, baseDmg + bonusDmg, castDmg)
    end
    ...
    if _G["spellData" .. playerClass][spellID].isDot or _G["spellData" .. playerClass][spellID].isChanDmg then
      ...
      valueDot = _G["ChimaSpellTheory_AddTalentValue" .. playerClass](spellID, baseDmg + bonusDmg, castDot)
    end
    ...
    -- if _G["spellData" .. playerClass][spellID].isMeleeDmg then
      ...
      -- valueDmg = _G["ChimaSpellTheory_AddTalentValue" .. playerClass](spellID, baseDmg, meleeDmg)
    -- end
...
function ChimaSpellTheory_CalculateHealPerMana(spellID)
  local hpm = 0
...
function ChimaSpellTheory_CalculateDmgPerMana(spellID)
  local dpm = 0
  local valueHeal, valueDmg = ChimaSpellTheory_CalculateDmgHealValue(spellID)
  local costs = GetSpellPowerCost(spellID)[1] and GetSpellPowerCost(spellID)[1].cost or 0
...
function ChimaSpellTheory_GetTalentPoints(tab, index)
