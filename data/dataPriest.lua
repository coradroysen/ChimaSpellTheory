spellDataPRIEST = {
  ...
  [10797] = { name="Starshards", rank=1, isChanDmg=true, fullDmgV=84, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19296] = { name="Starshards", rank=2, isChanDmg=true, fullDmgV=162, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19299] = { name="Starshards", rank=3, isChanDmg=true, fullDmgV=288, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19302] = { name="Starshards", rank=4, isChanDmg=true, fullDmgV=414, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19303] = { name="Starshards", rank=5, isChanDmg=true, fullDmgV=570, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19304] = { name="Starshards", rank=6, isChanDmg=true, fullDmgV=756, duration=6, dmgType=7, overTimeCoeff=1.714 },
  [19305] = { name="Starshards", rank=7, isChanDmg=true, fullDmgV=936, duration=6, dmgType=7, overTimeCoeff=1.714 },

  -- Holy
  [13908] = { name="Desperate Prayer", rank=1, isHeal=true, minHealV=148, maxHealV=185, instantCoeff=0.429 },
  [19236] = { name="Desperate Prayer", rank=2, isHeal=true, minHealV=283, maxHealV=346, instantCoeff=0.429 },
  ...
  [2054] = { name="Heal", rank=1, isHeal=true, minHealV=307, maxHealV=353, instantCoeff=0.857 },
  ...
  [2050] = { name="Lesser Heal", rank=1, isHeal=true, minHealV=47, maxHealV=58, instantCoeff=0.714 },
  [2052] = { name="Lesser Heal", rank=2, isHeal=true, minHealV=76, maxHealV=91, instantCoeff=0.714 },
  [2053] = { name="Lesser Heal", rank=3, isHeal=true, minHealV=143, maxHealV=165, instantCoeff=0.714 },
  ...
  [585] = { name="Smite", rank=1, isDmg=true, minDmgV=15, maxDmgV=20, dmgType=2, instantCoeff=0.714 },
  [591] = { name="Smite", rank=2, isDmg=true, minDmgV=28, maxDmgV=34, dmgType=2, instantCoeff=0.714 },
  [598] = { name="Smite", rank=3, isDmg=true, minDmgV=58, maxDmgV=67, dmgType=2, instantCoeff=0.714 },
  [984] = { name="Smite", rank=4, isDmg=true, minDmgV=97, maxDmgV=112, dmgType=2, instantCoeff=0.714 },
  [1004] = { name="Smite", rank=5, isDmg=true, minDmgV=158, maxDmgV=178, dmgType=2, instantCoeff=0.714 },
  [6060] = { name="Smite", rank=6, isDmg=true, minDmgV=222, maxDmgV=250, dmgType=2, instantCoeff=0.714 },
  [10933] = { name="Smite", rank=7, isDmg=true, minDmgV=298, maxDmgV=335, dmgType=2, instantCoeff=0.714 },
  [10934] = { name="Smite", rank=8, isDmg=true, minDmgV=384, maxDmgV=429, dmgType=2, instantCoeff=0.714 },

  -- Shadow
  [8092] = { name="Mind Blast", rank=1, isDmg=true, minDmgV=42, maxDmgV=46, dmgType=6, instantCoeff=0.429 },
  [8102] = { name="Mind Blast", rank=2, isDmg=true, minDmgV=76, maxDmgV=83, dmgType=6, instantCoeff=0.429 },
  [8103] = { name="Mind Blast", rank=3, isDmg=true, minDmgV=117, maxDmgV=126, dmgType=6, instantCoeff=0.429 },
  [8104] = { name="Mind Blast", rank=4, isDmg=true, minDmgV=174, maxDmgV=184, dmgType=6, instantCoeff=0.429 },
  [8105] = { name="Mind Blast", rank=5, isDmg=true, minDmgV=225, maxDmgV=239, dmgType=6, instantCoeff=0.429 },
  [8106] = { name="Mind Blast", rank=6, isDmg=true, minDmgV=288, maxDmgV=307, dmgType=6, instantCoeff=0.429 },
  [10945] = { name="Mind Blast", rank=7, isDmg=true, minDmgV=356, maxDmgV=377, dmgType=6, instantCoeff=0.429 },
  [10946] = { name="Mind Blast", rank=8, isDmg=true, minDmgV=437, maxDmgV=461, dmgType=6, instantCoeff=0.429 },
  [10947] = { name="Mind Blast", rank=9, isDmg=true, minDmgV=508, maxDmgV=537, dmgType=6, instantCoeff=0.429 },
