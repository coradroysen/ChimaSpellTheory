...
spellDataPRIEST = {
  ...
  [10797] = { name="Starshards", rank=1, isChanDmg=true, dotV=84, duration=6, dmgType=7, overTimeCoeff=1 },
  [19296] = { name="Starshards", rank=2, isChanDmg=true, dotV=162, duration=6, dmgType=7, overTimeCoeff=1 },
  ...
  [14914] = { name="Holy Fire", rank=1, isCastDmg=true, isDot = true, minDmgV=84, maxDmgV=104, dotV=30, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15262] = { name="Holy Fire", rank=2, isCastDmg=true, isDot = true, minDmgV=106, maxDmgV=131, dotV=40, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15263] = { name="Holy Fire", rank=3, isCastDmg=true, isDot = true, minDmgV=144, maxDmgV=178, dotV=55, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15264] = { name="Holy Fire", rank=4, isCastDmg=true, isDot = true, minDmgV=178, maxDmgV=223, dotV=65, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15265] = { name="Holy Fire", rank=5, isCastDmg=true, isDot = true, minDmgV=219, maxDmgV=273, dotV=85, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15266] = { name="Holy Fire", rank=6, isCastDmg=true, isDot = true, minDmgV=271, maxDmgV=340, dotV=100, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15267] = { name="Holy Fire", rank=7, isCastDmg=true, isDot = true, minDmgV=323, maxDmgV=406, dotV=125, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },
  [15261] = { name="Holy Fire", rank=8, isCastDmg=true, isDot = true, minDmgV=355, maxDmgV=449, dotV=145, duration=10, dmgType=2, instantCoeff=0.6, overTimeCoeff=0.27 },

  [15237] = { name="Holy Nova", rank=1, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=29, maxDmgV=34, minHealV=54, maxHealV=63, maxTargets=5, dmgType=2, instantCoeff=0.0714 }, -- 0.114?
  [15430] = { name="Holy Nova", rank=2, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=52, maxDmgV=61, minHealV=89, maxHealV=101, maxTargets=5, dmgType=2, instantCoeff=0.0714 },
  [15431] = { name="Holy Nova", rank=3, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=79, maxDmgV=92, minHealV=124, maxHealV=143, maxTargets=5, dmgType=2, instantCoeff=0.0714 },
  [27799] = { name="Holy Nova", rank=4, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=110, maxDmgV=127, minHealV=165, maxHealV=192, maxTargets=5, dmgType=2, instantCoeff=0.0714 },
  [27800] = { name="Holy Nova", rank=5, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=146, maxDmgV=168, minHealV=239, maxHealV=276, maxTargets=5, dmgType=2, instantCoeff=0.0714 },
  [27801] = { name="Holy Nova", rank=6, isCastDmg=true, isCastDmgAE=true, isHeal=true, isHealAE=true, minDmgV=181, maxDmgV=209, minHealV=302, maxHealV=350, maxTargets=5, dmgType=2, instantCoeff=0.0714 },
  ...
  [139] = { name="Renew", rank=1, isHot=true, hotV=45, duration=15, overTimeCoeff=1 },
  [6074] = { name="Renew", rank=2, isHot=true, hotV=100, duration=15, overTimeCoeff=1 },
  ...
  [585] = { name="Smite", rank=1, isCastDmg=true, minDmgV=15, maxDmgV=20, dmgType=2, instantCoeff=0.7142 },
  [591] = { name="Smite", rank=2, isCastDmg=true, minDmgV=28, maxDmgV=34, dmgType=2, instantCoeff=0.7142 },
  [598] = { name="Smite", rank=3, isCastDmg=true, minDmgV=58, maxDmgV=67, dmgType=2, instantCoeff=0.7142 },
  [984] = { name="Smite", rank=4, isCastDmg=true, minDmgV=97, maxDmgV=112, dmgType=2, instantCoeff=0.7142 },
  [1004] = { name="Smite", rank=5, isCastDmg=true, minDmgV=158, maxDmgV=178, dmgType=2, instantCoeff=0.7142 },
  [6060] = { name="Smite", rank=6, isCastDmg=true, minDmgV=222, maxDmgV=250, dmgType=2, instantCoeff=0.7142 },
  [10933] = { name="Smite", rank=7, isCastDmg=true, minDmgV=298, maxDmgV=335, dmgType=2, instantCoeff=0.7142 },
  [10934] = { name="Smite", rank=8, isCastDmg=true, minDmgV=384, maxDmgV=429, dmgType=2, instantCoeff=0.7142 },

  -- Shadow
  [8092] = { name="Mind Blast", rank=1, isCastDmg=true, minDmgV=42, maxDmgV=46, dmgType=6, instantCoeff=0.4285 },
  [8102] = { name="Mind Blast", rank=2, isCastDmg=true, minDmgV=76, maxDmgV=83, dmgType=6, instantCoeff=0.4285 },
  [8103] = { name="Mind Blast", rank=3, isCastDmg=true, minDmgV=117, maxDmgV=126, dmgType=6, instantCoeff=0.4285 },
  [8104] = { name="Mind Blast", rank=4, isCastDmg=true, minDmgV=174, maxDmgV=184, dmgType=6, instantCoeff=0.4285 },
  [8105] = { name="Mind Blast", rank=5, isCastDmg=true, minDmgV=225, maxDmgV=239, dmgType=6, instantCoeff=0.4285 },
  [8106] = { name="Mind Blast", rank=6, isCastDmg=true, minDmgV=288, maxDmgV=307, dmgType=6, instantCoeff=0.4285 },
  [10945] = { name="Mind Blast", rank=7, isCastDmg=true, minDmgV=356, maxDmgV=377, dmgType=6, instantCoeff=0.4285 },
  [10946] = { name="Mind Blast", rank=8, isCastDmg=true, minDmgV=437, maxDmgV=461, dmgType=6, instantCoeff=0.4285 },
  [10947] = { name="Mind Blast", rank=9, isCastDmg=true, minDmgV=508, maxDmgV=537, dmgType=6, instantCoeff=0.4285 },

  [589] = { name="Shadow Word: Pain", rank=1, isDot=true, dotV=30, duration=18, dmgType=6, overTimeCoeff=1 },
  [594] = { name="Shadow Word: Pain", rank=2, isDot=true, dotV=66, duration=18, dmgType=6, overTimeCoeff=1 },
  [970] = { name="Shadow Word: Pain", rank=3, isDot=true, dotV=132, duration=18, dmgType=6, overTimeCoeff=1 },
